...
function APICall(n){
  ...
  fetch('https://demo.infuseads.com:8081/core/key-count/?id=26', {
    method: 'POST',
    body: x,
    headers: {
...
function pg1func(op){
    ...
    btn1.style = "position: absolute;top: 192px;left: 46px;height: 59px;background: transparent;width: 107px;border-radius: 2%;border: 1px solid transparent;";
    ...
    btn2.style = "position: absolute;top: 192px;left: 167px;height: 59px;background: transparent;width: 107px;border-radius: 2%;border: 1px solid transparent;";
    ...
    home.style = "position: absolute;top: 380px;left: 65px;height: 57px;background: transparent;width: 188px;border-radius: 2%;border: 1px solid transparent;";
...
function pg2func(op){
    ...
    var home = document.getElementById("home");
    home.style = "position: absolute;top: 436px;left: 62px;height: 29px;background: transparent;width: 190px;border-radius: 2%;border: 1px solid transparent;";
    home.onclick= function(){
